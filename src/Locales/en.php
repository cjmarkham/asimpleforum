...
$translations = array(
	...
	'INVALID_CREDENTIALS' => 'The credentials you have entered do not match our records.',
	...
	'MIN_LENGTH' => 'The minimum length of the %field% must be %min% characters',
	'MAX_LENGTH' => 'The maximum length of the %field% is %max% characters'
);
